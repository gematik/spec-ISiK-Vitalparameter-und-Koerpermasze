...
Folgende Datenobjekte und Interaktionen aus dem Modul [ISiK Basis Stufe 3](https://simplifier.net/guide/isik-basis-v3?version=current) werden in diesem Modul verwendet:: 
