...
Alle bestätigungsrelevanten Systeme in diesem Modul nehmen nach QEDm die Rolle der *Data Source* ein (für mehr Informationen siehe [Basismodul - Abschnitt QEDm](https://simplifier.net/guide/isik-basis-v3/markdown-UebergreifendeFestlegungen-KompatibilitaetDerGematikSpezifikation?version=current)).
