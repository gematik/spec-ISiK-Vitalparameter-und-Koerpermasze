...
*Historie*: mit der Version 4.0.2 des IG ICU-Normalstation-Workflow wurde das vorliegende CapabilityStatement als eingenständige Rolle eingeführt.
...
* instantiates = Canonical(ISiKCapabilityStatementVitalSignICUSourceExtended)
* rest.mode = #server
* rest.resource[+]
